...
Pour plus d'informations, voir la section du manuel dédiée à SpeakerView.
...
<img src="./media-fr/media/image51.jpg"
 /><img src="./media-fr/media/image52.jpg"
 />

## 5.4. Réglages (Settings)

<img src="./media-fr/media/spatgris_settings.png"
 />
...
Cette section contient des réglages permettant de connecter SpatGRIS à une instance externe de SpeakerView qui peut par exmple se retrouver sur un autre ordinateur sur le même réseau. L'instance de SpeakerView intégré à SpatGRIS continuera de fonctionner même si vous connectez SpatGRIS à un SpeakerView externe.

- UDP Input Port: Le port UDP sur lequel SpatGRIS écoutera pour recevoir des signaux du SpeakverView externe.
- UDP Output Port: Le port UDP sur lequel SpatGRIS envois les données de visualisation au SpeakerView externe.
- UDP Output Address: L'addresse IP correspondant à la machine sur laquelle le SpeakerView externe se trouve.
...
<img src="./media-fr/media/image54.jpg"
 /><img src="./media-fr/media/image55.jpg"
 />
...
<img src="./media-fr/media/image56.jpg"
 /><img src="./media-fr/media/image57.jpg"
 />
...
<img src="./media-fr/media/image66.jpg"
 /><img src="./media-fr/media/image67.jpg"
 />
