...
Il est aussi possible de positionner des sources de manière à reproduire l'emplacement des hauts-parleurs d'un "speaker setup" de SpatGRIS. Pour utiliser cette fonctionnalité, cliquez sur l'icône de dossier dans l'onglet "Source" et choisissez un fichier de "speaker setup".
<img src="./media-fr/media/loadSpeakerSetupAsSourcePosition.png"/>
...
<img src="./media-fr/media/image23.jpg"
 /><img src="./media-fr/media/image24.jpg"
 />
...
<img src="./media-fr/media/image25.jpg"
 /><img src="./media-fr/media/image26.jpg"
 />
...
<img src="./media-fr/media/image29.jpg"
 /><img src="./media-fr/media/image30.jpg"
 />
...
<img src="./media-fr/media/image42.jpg"
 /><img src="./media-fr/media/image43.jpg"
 />
