...
For more information, see the SpeakerView section of the manual.
...
<img src="./media-en/media/image51.jpg"
 /><img src="./media-en/media/image52.jpg"
 />

## 5.4. Settings

<img src="./media-en/media/spatgris_settings.png"
 />
...
### Spatialisation Data Network Settings:
...
### Standalone SpeakerView Network Settings:

Cette section peut servir à connecter SpatGRIS à une instance externe de SpeakerView qui peut par exmple se retrouver sur un autre ordinateur sur le même réseau.

This section contains settings that allows connection to an external instance of SpeakerView. This external instance could be on another computer on your network. SpatGRIS's own SpeakerView instance will continue working even if you connect SpatGRIS to an external SpeakerView instance.

- UDP Input Port: UDP port on which SpatGRIS listens to receive signals from the external SpeakerView.
- UDP Output Port: UDP port where SpatGRIS will send visualization data to the external SpeakerView.
- UDP Output Address: IP address of the machine which is running the external SpeakerView instance.
...
<img src="./media-en/media/image54.jpg"
 /><img src="./media-en/media/image55.jpg"
 />
...
<img src="./media-en/media/image56.jpg"
 /><img src="./media-en/media/image57.jpg"
 />
...
<img src="./media-en/media/image66.jpg"
 /><img src="./media-en/media/image67.jpg"
 />
...
<img src="./media-en/media/manuel_gris_group_rotation.png"/>
